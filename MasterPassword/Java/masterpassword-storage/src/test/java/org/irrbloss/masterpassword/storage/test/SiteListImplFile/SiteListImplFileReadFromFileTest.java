...
public class SiteListImplFileReadFromFileTest {
	...
	/*@Test 
	public void testStoreSiteDescNormal() throws IOException,
			PermanentSyncException {

		//Arrange
		IFileSystemWrapper fs = org.easymock.EasyMock.createMock(IFileSystemWrapper.class);
		Path testPath = Paths.get("/tmp/");
		SiteListFile list = SiteListFile.getInstance ( testPath, fs );	
		SiteDescriptor s1 = new SiteDescriptor("site.com");		 						

		//Anticipate

		fs.writeFile(testPath.resolve(".mpw").resolve("7AEF11B08719DFB3B922E89EAC4B8D78"), s1.toFormatedText());
	...
	@Test @Ignore
	public void testGetNonexistentDesc() throws IOException,
	PermanentSyncException {
	}

	@Test @Ignore
	public void testStoreSiteDescOverWrite() throws IOException,
	PermanentSyncException {
	}

	@Test @Ignore
	public void testStoreSiteDescPutAll() throws IOException,
	PermanentSyncException {
	}

	@Test @Ignore
	public void testRemoveSiteDescNormal() throws IOException,
	PermanentSyncException {
	}

	@Test @Ignore
	public void testClearSiteDescNormal() throws IOException,
	PermanentSyncException {
	}
